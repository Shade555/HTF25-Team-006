...
const PodcastCard = ({ podcast, onViewScript, onDelete }) => (
  <div className="bg-slate-800 p-4 rounded-xl shadow-lg flex flex-col justify-between transition-transform duration-300 hover:shadow-xl hover:scale-[1.02]">
    <div>
...
const UploadSection = () => {
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      ...
      setFile(null);
      console.log(`Podcast generated for ${file.name}!`);
      // In a real app, this would trigger the actual AI API call and Firestore update.
    }, 3000);
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-wrap gap-4 items-start">
        ...
        <div className="w-full lg:w-1/4 lg:min-w-64">
          <div
            onDragOver={(e) => {
              e.preventDefault();
              setIsDragging(true);
...
const Dashboard = () => {
  ...
  return (
    <div
      className={`af-dashboard h-screen overflow-hidden ${
        darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-800"
